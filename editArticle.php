...
?>
	...
	<form action="editArticle.php" method= "POST" enctype = "multipart/form-data">
		...
		<input type="text" name = "collectionTitle" value = "<?php echo $article['collectionTitle']; ?>" required />
		...
		<input type="text" name = "auctionPeriod" value = "<?php echo $article['auctionPeriod']; ?>" required />

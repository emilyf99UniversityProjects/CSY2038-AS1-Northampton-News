...
?>
	...
	<form action="editUser.php" method= "POST">
		...
		<input type="text" name = "clientStatus" value = "<?php echo $user['clientStatus']; ?>" required />
		<label>Buyer Approved: </label>
		<input type="text" name = "buyerApproved" value = "<?php echo $user['buyerApproved']; ?>" required />

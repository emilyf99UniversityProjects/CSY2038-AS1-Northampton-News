...
if(isset($_SESSION['adminloggedin'])) {
	...
	if (isset($_POST['submit'])) {
    	$stmt = $pdo-> prepare('UPDATE sales SET lotNumber = :lotNumber, pieceTitle = :pieceTitle, commissionBids = :commissionBids,
		 reservePrice = :reservePrice, sold = :sold, price = :price, clientNumber = :clientNumber, auctionComments = :auctionComments
...
?>
	...
	<form action="editSales.php" method= "POST" enctype = "multipart/form-data">
		...
		<input type="text" name = "clientNumber" value = "<?php echo $sales['clientNumber']; ?>" required/>
